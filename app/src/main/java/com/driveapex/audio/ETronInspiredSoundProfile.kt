...
object ETronInspiredSoundProfile {
    val layers = listOf(
        ...
        SoundLayer(
            "motor_core", 700f, 25000f, 0.05f, 1.5f, 1.00f, 1, 0.34f,
        ...
        SoundLayer(
            "motor_harmonic", 1000f, 25000f, 0.10f, 1.5f, 2.00f, 2, 0.15f,
        ...
        SoundLayer(
            "electric_whine", 1800f, 25000f, 0.18f, 1.5f, 4.20f, 1, 0.055f,
        ...
        SoundLayer(
            "inverter_tone", 2200f, 25000f, 0.30f, 1.5f, 6.80f, 1, 0.022f,
        ...
        SoundLayer(
            "low_body", 700f, 25000f, 0.08f, 1.5f, 0.50f, 1, 0.24f,
        ...
        SoundLayer(
            "rotor_body", 800f, 25000f, 0.12f, 1.5f, 1.50f, 3, 0.055f,
